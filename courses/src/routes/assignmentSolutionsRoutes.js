...
.post(protect,assignmentSolutionController.uploadAssignmentSolution,assignmentSolutionController.addAssignmentSolution)

router
.route("/:id")
.get(protect,assignmentSolutionController.getAssignmentsSolutionById)
